...
const handleSuccessfulPayment = (paymentData, email) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield prisma_1.default.$transaction((trans) => __awaiter(void 0, void 0, void 0, function* () {
        yield trans.payment.create({
            data: Object.assign({ userId: user.id }, paymentData),
        });
        yield trans.event.update({
            where: {
    ...
    const successPaymentData = yield prisma_1.default.payment.findUnique({
        where: {
...
const getMyPayments = (email) => __awaiter(void 0, void 0, void 0, function* () {
